...
# titre_data <-  "/work/adanguy/these/pipeline/020820/intervals/intervals.txt"           
# titre_aleatoires_chrregion <- "/work/adanguy/these/pipeline/020820/modele/chrregion_lambda_random.txt"
